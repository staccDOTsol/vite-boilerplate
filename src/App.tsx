...
const App = () => {
  ...
  const contractAddress = 'EQAYzaoIhA1SAQbuLXKN8e_MPLyWHpo6utBUkA1QgH_1g7bk';
  ...
  useEffect(() => {const fetchGameData = async () => {
    ...
    try {
      ...
      setLastPlayer(lastBuyer.toString().substring(0, 4) + '...' + lastBuyer.toString().substring(lastBuyer.toString().length - 4));
    } catch (error) {
